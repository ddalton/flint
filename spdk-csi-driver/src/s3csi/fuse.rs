...
900 25 0:23 /plugins/s3.flint.io/volumes/csi-abc/tree /var/lib/kubelet/pods/uid/volumes/kubernetes.io~csi/ws/mount rw,relatime shared:15 - ext4 /dev/vda1 rw
901 25 0:44 / /var/lib/kubelet/plugins/s3.flint.io/volumes/csi-def/src rw,nosuid,nodev,noatime shared:99 - fuse mount-s3 rw,user_id=1001
";
        ...
        assert!(mountinfo_has(info, "/var/lib/kubelet/plugins/s3.flint.io/volumes/csi-def/src"));
        assert!(!mountinfo_has(info, "/var/lib/kubelet/plugins/s3.flint.io/volumes/csi-abc/tree"), "the bind SOURCE is not itself a mount point");
