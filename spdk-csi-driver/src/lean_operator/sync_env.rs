...
mod tests {
    ...
    fn the_env_is_the_fixed_list_with_defaults_stamped() {
        ...
        for k in ["FLINT_SYNC_FLOOR_SECS", "FLINT_SYNC_MAX_FILES", "FLINT_SYNC_FANOUT", "FLINT_SYNC_FETCH_DRIVERS", "FLINT_SYNC_RAW_READS", "FLINT_SYNC_BOUNDARY_MODE", "FLINT_SYNC_METRICS_PORT"] {
