#!/bin/bash
# H1f, fourth pass: the leak worlds rearranged around the restore;: Inv_TreesConverged no longer excuses a queued deletion the
...
BAD=0
expect LeanBarrierLeaseLeakResurrects fail
expect LeanBarrierLeaseLeakHolds hold
expect LeanBarrierLeaseLeakRetiredOnly hold
expect LeanBarrierLeaseLeakRestoreOnly hold
expect LeanBarrierLeaseLeakFlaps fail
expect LeanBarrierLeaseLeakRuleConverges hold
expect LeanBarrierLeaseLeakSkippedGeneration fail
expect LeanProbeTombstoneOverLeak fail
echo "LEAKDONE bad=$BAD"
