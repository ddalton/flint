...
image:https://github.com/ddalton/flint/actions/workflows/formal.yml/badge.svg?branch=main[formal,link=https://github.com/ddalton/flint/actions/workflows/formal.yml]
...
//
// `formal` is the TLA+ gate. A green badge there says the models still
