...
**Last updated:** 2026-05-03 — Conformance work concluded (167/4/91); cross-host bench harness scaffolded (`make test-pnfs-cross-host`), waiting on a K8s cluster to run.
**Branch:** `kind-no-spdk`. **HEAD:** (pending this commit).
