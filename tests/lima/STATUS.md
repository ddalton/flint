...
**Last updated:** 2026-05-02, after Phase A.4 of production-readiness (DS-death → CB_LAYOUTRECALL fan-out wired into the heartbeat monitor + Lima e2e test).
**Branch:** `kind-no-spdk`.
